                ...
                <div class="beta-products-list">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="single-item">
                                <div class="single-item-header">
                                    <a href="/product_details"><img src="source/assets/dest/images/products/4.jpg" alt=""></a>
                                </div>
                                <div class="single-item-body">
                                    <p class="single-item-title">Sample Woman Top</p>
                                    <p class="single-item-price">
                                ...
                                <div class="single-item-caption">
                                    <a class="add-to-cart pull-left" href="/product_details"><i class="fa fa-shopping-cart"></i></a>
                        ...
                        <div class="col-sm-4">
                            <div class="single-item">
                                <div class="single-item-header">
                                    <a href="/product_details"><img src="source/assets/dest/images/products/5.jpg" alt=""></a>
                                </div>
                                <div class="single-item-body">
                                    <p class="single-item-title">Sample Woman Top</p>
                                    <p class="single-item-price">
                    ...
                    <div class="widget-body">
                        <div class="beta-sales beta-lists">
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="/product_details"><img src="source/assets/dest/images/products/sales/1.png" alt=""></a>
                            ...
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="/product_details"><img src="source/assets/dest/images/products/sales/2.png" alt=""></a>
                                <div class="media-body">
                                    Sample Woman Top
                                    <span class="beta-sales-price">$34.55</span>
                                </div>
                            ...
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="/product_details"><img src="source/assets/dest/images/products/sales/3.png" alt=""></a>
                                <div class="media-body">
                                    Sample Woman Top
                                    <span class="beta-sales-price">$34.55</span>
                                </div>
                            ...
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="/product_details"><img src="source/assets/dest/images/products/sales/4.png" alt=""></a>
                                <div class="media-body">
                                    Sample Woman Top
                                    <span class="beta-sales-price">$34.55</span>
                                </div>
