					...
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">{{count($new_product)}} new products found</p>
                                ...
                                <div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="/product_details"><img src="source/image/product/{{$new->image}}" alt=""></a>
										</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
                                @foreach ($top_product as $tp)
									...
									<div class="single-item">
										<div class="single-item-header">
											<a href="/product_details"><img src="source/image/product/{{$tp->image}}" alt=""></a>
										</div>
										<div class="single-item-body">
								...
								{{-- <div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="/product_details"><img src="source/assets/dest/images/products/2.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
								...
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="/product_details"><img src="source/assets/dest/images/products/3.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">Sample Woman Top</p>
											<p class="single-item-price">
